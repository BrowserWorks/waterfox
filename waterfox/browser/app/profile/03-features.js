...
pref("browser.newtabpage.activity-stream.showSearch", false, locked); // Hide the search bar on the New Tab Page.
pref("browser.newtabpage.activity-stream.improvesearch.topSiteSearchShortcuts", true); // Show search shortcuts (e.g., @bookmarks) on Top Sites.
...
pref("browser.newtabpage.activity-stream.system.showWeather", false); // If true, this would hide "Weather" as a configurable UI option in NTP settings.
...
pref("browser.aboutwelcome.enabled", false); // Disable "Intro" / "Welcome" screens shown on first launch or after updates.
...
pref("browser.urlbar.suggest.topsites", false); // Disable suggesting top sites when the URL bar is empty and focused.
